        ...
        <div class="content-header">
            <nav aria-label="breadcrumb">
              <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Deactive account</li>
              </ol>
            </nav>
                               ...
                               <?php 
                                ...
                                <tr>
                                    ...
                                    <td class="text-center pt-3">
                                        ...
                                        <?php 
                                        if ($result['status'] == '0') {?>
                                        <a class="btn btn-warning text-white" onclick="return confirm('Are you sure to Delete Deactive ?')" href="?disid=<?php echo $result['userid']; ?>">&nbspDeactive&nbsp</a>
                                        <?php } else{?>
                                        <a class="btn btn-warning text-white" onclick="return confirm('Are you sure to Delete Active ?')" href="?enid=<?php echo $result['userid']; ?>">&nbspActive&nbsp</a>
                                        <?php } ?>
                                ...
                                <?php }}else{  ?>
                                    ...
                                    <tr>
                                        <td colspan="7" class="text-center">No Band user yet !</td>
                                    </tr>
                                <?php } ?>

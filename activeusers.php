                               ...
                               <?php 
                                ...
                                <tr>
                                    ...
                                    <td class="text-center pt-3">
                                        ...
                                        <a class="btn btn-danger" onclick="return confirm('Are you sure to Delete account ?')" href="?delid=<?php echo $result['userid']; ?>">&nbspDelete&nbsp</a></td>
                                </tr>
                              
                                <?php }}else{  ?>

                                    <tr>
                                        <td colspan="7" class="text-center">No active users yet !</td>
                                    </tr>
                                <?php } ?>
